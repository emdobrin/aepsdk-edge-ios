...
class EdgeNetworkServiceTests: XCTestCase {
    ...
    private let edgeHitPayload = ExperienceEventsEdgeHit(edgeEndpoint: EdgeEndpoint(environmentType: .production), configId: "configIdExample", request: EdgeRequest(meta: nil, xdm: nil, events: [["test": "data"]])).getPayload()
